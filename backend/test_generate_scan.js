...
async function run() {
    try {
        ...
        // Generate test for history, kg, 5 (id: history, grade: 5)
        ...
        if (gen.questions) {
            ...
            if (withImage.length > 0) {
                console.log('Question with image:', JSON.stringify(withImage[0], null, 2));
            } else {
                console.log('No questions with image found in this generated test.');
            }
        } else {
